...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ App)\n/* harmony export */ });\n/* harmony import */ var _constant_variables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constant/variables */ \"./src/constant/variables.ts\");\n/* harmony import */ var _utils_Dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/Dom */ \"./src/utils/Dom.ts\");\n/* harmony import */ var _utils_fetch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/fetch */ \"./src/utils/fetch.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __classPrivateFieldSet = (undefined && undefined.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {\n    if (kind === \"m\") throw new TypeError(\"Private method is not writable\");\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a setter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot write private member to an object whose class did not declare it\");\n    return (kind === \"a\" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;\n};\nvar __classPrivateFieldGet = (undefined && undefined.__classPrivateFieldGet) || function (receiver, state, kind, f) {\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a getter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot read private member from an object whose class did not declare it\");\n    return kind === \"m\" ? f : kind === \"a\" ? f.call(receiver) : f ? f.value : state.get(receiver);\n};\nvar _App_movieList, _App_page, _App_listState, _App_movieName;\n\n\n\nclass App {\n    constructor() {\n        _App_movieList.set(this, void 0);\n        _App_page.set(this, void 0);\n        _App_listState.set(this, _constant_variables__WEBPACK_IMPORTED_MODULE_0__.LIST_STATE.POPULAR);\n        _App_movieName.set(this, void 0);\n        this.initRender();\n        this.setEvent();\n    }\n    initRender() {\n        return __awaiter(this, void 0, void 0, function* () {\n            __classPrivateFieldSet(this, _App_movieList, [], \"f\");\n            __classPrivateFieldSet(this, _App_page, 1, \"f\");\n            this.renderMovieList();\n        });\n    }\n    renderMovieList() {\n        return __awaiter(this, void 0, void 0, function* () {\n            this.render();\n            this.toggleSkeletonList();\n            yield this.addMovieList();\n            this.toggleSkeletonList();\n            this.mountMovieList();\n        });\n    }\n    render() {\n        const itemView = (0,_utils_Dom__WEBPACK_IMPORTED_MODULE_1__.$)('.item-view');\n        const listTitle = __classPrivateFieldGet(this, _App_listState, \"f\") === _constant_variables__WEBPACK_IMPORTED_MODULE_0__.LIST_STATE.POPULAR\n            ? '지금 인기 있는 영화'\n            : `\"${__classPrivateFieldGet(this, _App_movieName, \"f\")}\" 검색 결과`;\n        itemView.innerHTML = `\n    <card-list header='${listTitle}\n    '></card-list>\n    <more-button></more-button>\n    `;\n    }\n    setEvent() {\n        return __awaiter(this, void 0, void 0, function* () {\n            document.addEventListener('click-more-button', () => {\n                this.toggleSkeletonList();\n                this.appendMovieList();\n            });\n            document.addEventListener('search-movie', (event) => {\n                __classPrivateFieldSet(this, _App_listState, _constant_variables__WEBPACK_IMPORTED_MODULE_0__.LIST_STATE.SEARCHED, \"f\");\n                __classPrivateFieldSet(this, _App_page, 1, \"f\");\n                __classPrivateFieldSet(this, _App_movieList, [], \"f\");\n                __classPrivateFieldSet(this, _App_movieName, event.detail, \"f\");\n                if (event.detail === '') {\n                    __classPrivateFieldSet(this, _App_listState, _constant_variables__WEBPACK_IMPORTED_MODULE_0__.LIST_STATE.POPULAR, \"f\");\n                    this.initRender();\n                }\n                else {\n                    this.renderMovieList(event.detail);\n                }\n            });\n            document.addEventListener('click-home-button', () => {\n                __classPrivateFieldSet(this, _App_listState, _constant_variables__WEBPACK_IMPORTED_MODULE_0__.LIST_STATE.POPULAR, \"f\");\n                this.initRender();\n            });\n        });\n    }\n    appendMovieList() {\n        return __awaiter(this, void 0, void 0, function* () {\n            __classPrivateFieldSet(this, _App_page, __classPrivateFieldGet(this, _App_page, \"f\") + 1, \"f\");\n            __classPrivateFieldSet(this, _App_movieList, [], \"f\");\n            __classPrivateFieldGet(this, _App_listState, \"f\") === _constant_variables__WEBPACK_IMPORTED_MODULE_0__.LIST_STATE.POPULAR\n                ? yield this.addMovieList()\n                : yield this.addMovieList();\n            this.toggleSkeletonList();\n            this.mountMovieList();\n        });\n    }\n    addMovieList() {\n        return __awaiter(this, void 0, void 0, function* () {\n            const fetchedData = __classPrivateFieldGet(this, _App_listState, \"f\") === _constant_variables__WEBPACK_IMPORTED_MODULE_0__.LIST_STATE.POPULAR\n                ? yield (0,_utils_fetch__WEBPACK_IMPORTED_MODULE_2__.getPopularMovies)(__classPrivateFieldGet(this, _App_page, \"f\"))\n                : yield (0,_utils_fetch__WEBPACK_IMPORTED_MODULE_2__.getSearchedMovies)(__classPrivateFieldGet(this, _App_movieName, \"f\"), __classPrivateFieldGet(this, _App_page, \"f\"));\n            const result = fetchedData.results;\n            const newMovieList = result.map((item) => ({\n                title: item.title,\n                poster: item.poster_path,\n                rating: item.vote_average,\n            }));\n            __classPrivateFieldSet(this, _App_movieList, [...__classPrivateFieldGet(this, _App_movieList, \"f\"), ...newMovieList], \"f\");\n        });\n    }\n    mountMovieList() {\n        var _a;\n        (_a = (0,_utils_Dom__WEBPACK_IMPORTED_MODULE_1__.$)('card-list')) === null || _a === void 0 ? void 0 : _a.setMovieList(__classPrivateFieldGet(this, _App_movieList, \"f\"));\n    }\n    toggleSkeletonList() {\n        (0,_utils_Dom__WEBPACK_IMPORTED_MODULE_1__.$)('card-list').toggleSkeletonList();\n    }\n}\n_App_movieList = new WeakMap(), _App_page = new WeakMap(), _App_listState = new WeakMap(), _App_movieName = new WeakMap();\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/App.js?");

/***/ }),

/***/ "./src/components/MoreButton.js":
/*!**************************************!*\
  !*** ./src/components/MoreButton.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ MoreButton)\n/* harmony export */ });\n/* harmony import */ var _utils_Dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/Dom */ \"./src/utils/Dom.ts\");\n\nclass MoreButton extends HTMLElement {\n    connectedCallback() {\n        this.innerHTML = ` \n       <button id=\"more-button\" class=\"btn primary full-width\">\n            더 보기\n       </button>`;\n        this.setEvent();\n    }\n    setEvent() {\n        (0,_utils_Dom__WEBPACK_IMPORTED_MODULE_0__.$)(\"#more-button\").addEventListener(\"click\", () => {\n            this.dispatchEvent(new CustomEvent(\"click-more-button\", { bubbles: true }));\n        });\n    }\n}\ncustomElements.define(\"more-button\", MoreButton);\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/components/MoreButton.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ MovieSearch)\n/* harmony export */ });\n/* harmony import */ var _utils_Dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/Dom */ \"./src/utils/Dom.ts\");\n/* harmony import */ var _App__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../App */ \"./src/App.js\");\n\n\nclass MovieSearch extends HTMLElement {\n    connectedCallback() {\n        this.innerHTML = `\n         <div class=\"search-box\">\n          <input type=\"text\" placeholder=\"검색\" />\n          <button class=\"search-button\">검색</button>\n         </div>\n        `;\n        this.setEvent();\n    }\n    setEvent() {\n        (0,_utils_Dom__WEBPACK_IMPORTED_MODULE_0__.$)(\".search-button\").addEventListener(\"click\", () => {\n            this.createSearchMovieEvent();\n        });\n        (0,_utils_Dom__WEBPACK_IMPORTED_MODULE_0__.$)(\"input\").addEventListener(\"keypress\", (e) => {\n            if (e.key === \"Enter\")\n                this.createSearchMovieEvent();\n        });\n    }\n    createSearchMovieEvent() {\n        const movieName = (0,_utils_Dom__WEBPACK_IMPORTED_MODULE_0__.$)(\"input\").value;\n        this.dispatchEvent(new CustomEvent(\"search-movie\", { bubbles: true, detail: movieName }));\n    }\n}\ncustomElements.define(\"movie-search\", MovieSearch);\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/components/MovieSearch.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ SkeletonList)\n/* harmony export */ });\n/* harmony import */ var _constant_variables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constant/variables */ \"./src/constant/variables.ts\");\n\nclass SkeletonList extends HTMLElement {\n    connectedCallback() {\n        this.innerHTML =\n            `<ul class=\"item-list\">\n          ${_constant_variables__WEBPACK_IMPORTED_MODULE_0__.SKELETON.ITEM.repeat(20)}\n        </ul>\n        `;\n    }\n}\ncustomElements.define(\"skeleton-list\", SkeletonList);\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/components/SkeletonList.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _MovieCardList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MovieCardList */ \"./src/components/MovieCardList.js\");\n/* harmony import */ var _MoreButton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MoreButton */ \"./src/components/MoreButton.js\");\n/* harmony import */ var _MovieCard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MovieCard */ \"./src/components/MovieCard.js\");\n/* harmony import */ var _MovieHeader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MovieHeader */ \"./src/components/MovieHeader.js\");\n/* harmony import */ var _MovieSearch__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./MovieSearch */ \"./src/components/MovieSearch.js\");\n/* harmony import */ var _SkeletonList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./SkeletonList */ \"./src/components/SkeletonList.js\");\n\n\n\n\n\n\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/components/index.js?");
